...
// Profile saved successfuly
    ...
    public void enterData(String email, String name, String phone, String city, String country, String twitter, String gitHub) {
        getEmailField().clear();
        ...
        getCityField().clear();
        getCityField().sendKeys("Bogotá");
        //getCityField().selectByVisibleText("Bogotá");
        getCountryField().clear();
        getCountryField().sendKeys(country);
        getTwitterField().clear();
